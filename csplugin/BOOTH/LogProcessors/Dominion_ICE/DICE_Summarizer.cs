...
{
    class DICE_Summarizer : ILogSummarizer
    {
        ...
        public void CreateSummaryFrom(Worksheet sheet)
        {
            ...
            PivotTable pvt = pvtCache.CreatePivotTable(
                ...
                TableName: "DICESummaryStats"
                );
            pvt.AddDataField(pvt.PivotFields("Event"), "Count of Event Type",
                XlConsolidationFunction.xlCount);
            pvt.AddDataField(pvt.PivotFields("Event"), "Percent of Event Type",
                XlConsolidationFunction.xlCount);
            pvt.PivotFields("Percent of Event Type").Calculation = XlPivotFieldCalculation.xlPercentOfColumn;
            ...
            pvt.PivotFields("Event").Orientation = Microsoft.Office.Interop.Excel.XlPivotFieldOrientation.xlRowField;
