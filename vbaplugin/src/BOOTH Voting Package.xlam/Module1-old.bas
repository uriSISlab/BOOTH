Sub CheckInTimerOpen(control As IRibbonControl)

C = 1
    While C < ActiveWorkbook.Sheets.Count + 1
        If ActiveWorkbook.Sheets(C).Name = "CheckInTimer" Then
            ActiveWorkbook.Sheets(C).Activate
            CheckInForm.Show
            GoTo NoCITimer
        Else: C = C + 1
        End If
...
ActiveWorkbook.Sheets.Add.Name = "CheckInTimer"
ActiveWorkbook.Sheets("CheckInTimer").Activate
CheckInForm.Show

NoCITimer:

End Sub
Sub CheckInArrivalTimerOpen(control As IRibbonControl)

C = 1
    While C < ActiveWorkbook.Sheets.Count + 1
        If ActiveWorkbook.Sheets(C).Name = "CheckInArrivalTimer" Then
            ActiveWorkbook.Sheets(C).Activate
            CheckInArrivalForm.Show
            GoTo NoCIATimer
        Else: C = C + 1
        End If
    Wend

ActiveWorkbook.Sheets.Add.Name = "CheckInArrivalTimer"
ActiveWorkbook.Sheets("CheckInArrivalTimer").Activate
CheckInArrivalForm.Show
...
End Sub
Sub VotingBoothTimerOpen(control As IRibbonControl)

C = 1
    While C < ActiveWorkbook.Sheets.Count + 1
        If ActiveWorkbook.Sheets(C).Name = "VotingBoothTimer" Then
            ActiveWorkbook.Sheets(C).Activate
            VotingBoothForm.Show
            GoTo NoVBTimer
        Else: C = C + 1
        End If
    Wend

ActiveWorkbook.Sheets.Add.Name = "VotingBoothTimer"
ActiveWorkbook.Sheets("VotingBoothTimer").Activate
VotingBoothForm.Show
...
End Sub
Sub BMDTimerOpen(control As IRibbonControl)

C = 1
    While C < ActiveWorkbook.Sheets.Count + 1
        If ActiveWorkbook.Sheets(C).Name = "BMDTimer" Then
            ActiveWorkbook.Sheets(C).Activate
            BMDForm.Show
            GoTo NoBMDTimer
        Else: C = C + 1
...
ActiveWorkbook.Sheets.Add.Name = "BMDTimer"
ActiveWorkbook.Sheets("BMDTimer").Activate
BMDForm.Show
...
End Sub
Sub BallotScanningTimerOpen(control As IRibbonControl)

C = 1
    While C < ActiveWorkbook.Sheets.Count + 1
        If ActiveWorkbook.Sheets(C).Name = "BallotScanTimer" Then
            ActiveWorkbook.Sheets(C).Activate
            ScannerForm.Show
            GoTo NoScanTimer
        Else: C = C + 1
...
ActiveWorkbook.Sheets.Add.Name = "BallotScanTimer"
ActiveWorkbook.Sheets("BallotScanTimer").Activate
ScannerForm.Show
...
End Sub
Sub ThroughputArrivalTimerOpen(control As IRibbonControl)

C = 1
    While C < ActiveWorkbook.Sheets.Count + 1
        If ActiveWorkbook.Sheets(C).Name = "ThroughputArrivalTimer" Then
            ActiveWorkbook.Sheets(C).Activate
            ThroughputArrivalForm.Show
            GoTo NoTATimer
        Else: C = C + 1
        End If
    Wend

ActiveWorkbook.Sheets.Add.Name = "ThroughputArrivalTimer"
ActiveWorkbook.Sheets("ThroughputArrivalTimer").Activate
ThroughputArrivalForm.Show
